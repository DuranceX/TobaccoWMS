...
public class SupplierFragment_origin extends Fragment {
    SupplierListAdapter adapter;
    RecyclerView recyclerView;
    SearchView searchView;
    IconFontTextView addButton;

    public SupplierFragment_origin() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(v->{
            BottomDialog.show("新增客户", "这里是对话框内容", new OnBindView<BottomDialog>(R.layout.dialog_add_customer_supplier) {
                @Override
